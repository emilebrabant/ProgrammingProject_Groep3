...
function CommissieShell({ title, subtitle, activeTab, children }) {
    ...
    <div style={{ minHeight: '100vh', background: 'linear-gradient(180deg, #fffaf1 0%, #fff1d6 100%)' }}>
      <div className="container py-5">
        <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
          <div>
            <p className="text-uppercase text-warning-emphasis mb-1 small">Commissie shell</p>
            <h1 className="mb-1">{title}</h1>
            <p className="text-secondary mb-0">{subtitle}</p>
          </div>
          <div className="d-flex align-items-center gap-3">
            <div className="text-end">
              <div className="fw-semibold">{user?.naam || 'Commissie'}</div>
        ...
        <div className="d-flex flex-wrap gap-2 mb-4">
          <Link className={tabClass('stages')} to="/commissie/stages">
            Stagevoorstellen
          </Link>
        </div>
